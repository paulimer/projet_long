...
adata_ref = sc.read_csv("/home/paulet/data/sc_mousebrain_allen/sc_allen/subsampled_cells_indiv_w_ensembl.csv", first_column_names=True)
...
with mpl.rc_context({'axes.facecolor':  'black',
    ...
    sq.pl.spatial_scatter(adata_vis, img_cmap='magma',
                  ...
                  color=['CGE', 'L2/3 IT', 'L4/5/6 IT Car3', 'MGE', 'NP/CT/L6b', 'Other', 'PT'],
                  ncols=4, size=1.3)
                  # img_key='hires')#,
